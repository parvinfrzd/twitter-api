...
var T = new Twit({
  consumer_key: TWITTER_KEYS.apikey,
  consumer_secret: TWITTER_KEYS.apiSecretKey,
  access_token: TWITTER_KEYS.accessToken,
  access_token_secret: TWITTER_KEYS.accessTokenSecret,
});

(async () => {

  // //1. GET RECENT TWEETS
  T.get('search/tweets', { q: '#vegan since:2020-04-15', count: 2 }, function (err, data, response) {
